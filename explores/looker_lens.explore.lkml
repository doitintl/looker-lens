...
explore: history_data {
  ...
  join: job_statistics__reservation_usage {
    view_label: "BigQuery"
    sql: LEFT JOIN UNNEST(${bq_audit_logs.job_statistics__reservation_usage_array}) as job_statistics__reservation_usage ;;
    relationship: one_to_many
  }
  ...
  join: job_statistics__referenced_tables {
    view_label: "BigQuery"
    sql: LEFT JOIN UNNEST(${bq_audit_logs.job_statistics__referenced_tables_array}) as job_statistics__referenced_tables ;;
    relationship: one_to_many
  }
